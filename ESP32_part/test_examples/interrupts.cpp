...
#define SPEED_READ_PIN 34

#define SLIDE_WINDOW_IN_MILLIS 50.0
...
void IRAM_ATTR wheel_1_speed_measure(){
  cur_state_wheel_1 = digitalRead(SPEED_READ_PIN);
...
void IRAM_ATTR wheel_2_speed_measure(){
  cur_state_wheel_2 = digitalRead(SPEED_READ_PIN);
...
void IRAM_ATTR wheel_3_speed_measure(){
  cur_state_wheel_3 = digitalRead(SPEED_READ_PIN);
...
void IRAM_ATTR wheel_4_speed_measure(){
  cur_state_wheel_4 = digitalRead(SPEED_READ_PIN);
...
void setup() {
  ...
  prev_state_wheel_1 = digitalRead(SPEED_READ_PIN);
  prev_state_wheel_2 = digitalRead(SPEED_READ_PIN);
  prev_state_wheel_3 = digitalRead(SPEED_READ_PIN);
  prev_state_wheel_4 = digitalRead(SPEED_READ_PIN);
...
void loop() {
  ...
  Serial.println(COUNTER_MULTIPLIER * counter_1);
